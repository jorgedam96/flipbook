...
class RecyclerViewAdapter(
    ...
    fun setData(datos: ArrayList<Libro>) {
        this.mData = datos
    }
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.cardView.setOnClickListener {
            ...
            val myFragment: Fragment = DetalleLibroFragment(mData[position], vista)
            activity!!.supportFragmentManager.beginTransaction()
                .replace(R.id.parent_view, myFragment).addToBackStack(null).commit()
    ...
    class MyViewHolder(itemView: View) :
        ...
        var autor: TextView = itemView.findViewById<View>(R.id.book_autor) as TextView
        var img_book_thumbnail: ImageView =
            itemView.findViewById<View>(R.id.book_img_id) as ImageView
